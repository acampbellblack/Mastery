...
namespace Mastery.States.Gameplay
{
    public class GameplayState : BaseGameState
    {
        ...
        public override void LoadContent()
        {
            ...
            _soundManager.RegisterSound(new GameplayEvent.PlayerShootsBullets(), bulletSound);
            _soundManager.RegisterSound(new GameplayEvent.PlayerShootsMissile(), missileSound, 0.4f, -0.2f, 0.0f);
        ...
        public void RegulateShootingRate(GameTime gameTime)
        {
            // can't shoot bullets more than every 0.2 seconds
        ...
        private void DetectCollisions()
        {
            ...
            {
                var hitEvent = new GameplayEvent.ChopperHitBy(bullet);
            ...
            {
                var hitEvent = new GameplayEvent.ChopperHitBy(missile);
                chopper.OnNotify(hitEvent);
                _soundManager.OnNotify(hitEvent);
                missile.Destroy();
            });
        ...
        private void _chopperSprite_OnObjectChanged(object sender, BaseGameStateEvent e)
        {
            ...
            switch (e)
            {
                case GameplayEvent.EnemyLostLife ge:
                    if (ge.CurrentLife <= 0)
                    {
        ...
        private void Shoot(GameTime gameTime)
        {
            if (!_isShootingBullets)
            {
                ...
                NotifyEvent(new GameplayEvent.PlayerShootsBullets());
            }
            ...
            if (!_isShootingMissile)
            {
                ...
                NotifyEvent(new GameplayEvent.PlayerShootsMissile());
            }
        }
